...
<fieldset>
	...
	<ul>
		...
		<li>hr : 수평선을 긋어주는 태그=>html5에서는 section을 구분해주는 기능으로 변경됨.</li>
	</ul>
</fieldset>
<p>첫번째 문단</p>
<p>두번째 문단</p>
<p>세번째 문단 <br/><br/> 줄을 바꾼후 한줄이 떨어짐</p>
<hr/>

<fieldset>
	<legend>strong or b | i | q | mark | span </legend>
	<ul>
		<li>strong or b : 문자를 굵게</li>
		<li>i : 이탤릭체</li>
		<li>q : 인용 부호. blockquote와 유사하지만 인라인 형태임.</li>
		<li>mark : 현광펜 유형</li>
